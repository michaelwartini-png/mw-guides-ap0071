export const HIGHLIGHT_ICON_OPTIONS = [
  ...
  { value: "deck", label: "Offenes Deck", emoji: "🌤️" },
...
export const DEFAULT_HIGHLIGHTS_DATA: HighlightsData = {
  items: [
    createItem({
      ...
      kurzbeschreibung: "Blick auf See und Alpen während der gesamten Überfahrt.",
      icon: "view",
      galerieBildId: "gk1",
      reihenfolge: 1,
      aktiv: true,
    ...
    createItem({
      id: "k6",
      titel: "Offenes Deck",
      kurzbeschreibung: "Unverstellter Blick vom offenen Deck – der beste Platz bei klarem Wetter.",
      icon: "deck",
      galerieBildId: null,
      reihenfolge: 2,
      aktiv: true,
