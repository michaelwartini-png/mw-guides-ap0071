...
/** AP-ET004.1 — Left sidebar in review mode (no Erlebniswelten). */
export function ReviewSidebar({ review }: ReviewSidebarProps) {
    ...
    <aside className="flex flex-col rounded-2xl bg-[var(--mwg-ink)] px-5 py-6 text-[var(--mwg-paper)] lg:sticky lg:top-[92px] lg:min-h-[calc(100vh-120px)]">
      ...
      <section className="mt-auto border-t border-white/10 pt-6">
        ...
        <div className="mt-4 flex items-center gap-4">
          <ProgressRing value={review.progressPercent} />
          <p className="text-[13px] font-medium text-white">{review.progressPercent} % abgeschlossen</p>
        </div>
