...
export const metadata: Metadata = {
  title: "Blog",
  description: "Geschichten und Hintergründe rund um unsere Touren. Inhalte folgen in einem späteren Arbeitspaket.",
};
      ...
      <main className="flex-1">
        <section className="mx-auto max-w-[1240px] px-6 py-28 lg:px-10">
          ...
          <p className="mt-4 max-w-[560px] text-[15px] leading-relaxed text-[var(--mwg-ink-70)]">
            Geschichten und Hintergründe rund um unsere Touren. Inhalte folgen in einem späteren Arbeitspaket.
          </p>
        </section>
      </main>
      <Footer />
